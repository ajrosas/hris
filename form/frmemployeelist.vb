...
<<<<<<< HEAD
    ...
    Private Sub txtsupervisorname_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtsupervisorname.TextChanged
        'Uppercase first character
        txtsupervisorname.Text = Globalization.CultureInfo.CurrentCulture.TextInfo.ToTitleCase(txtsupervisorname.Text)
        txtsupervisorname.SelectionStart = txtsupervisorname.TextLength + 1
    End Sub
